          ...
          <div className="bg-white rounded-xl border shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-yellow-600">{(stats === null || stats === void 0 ? void 0 : stats.totalPending) || 0}</p>
          ...
          <div className="bg-white rounded-xl border shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                ...
                <span className="text-green-900 font-bold">{(stats === null || stats === void 0 ? void 0 : stats.totalAccepted) || 0}</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                ...
                <span className="text-yellow-900 font-bold">{(stats === null || stats === void 0 ? void 0 : stats.totalPending) || 0}</span>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                ...
                <span className="text-red-900 font-bold">{(stats === null || stats === void 0 ? void 0 : stats.totalRejected) || 0}</span>
              </div>
            </div>
          </div>
