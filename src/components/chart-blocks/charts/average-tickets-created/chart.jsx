        ...
        <ChartContainer config={chartConfig}>
          <ResponsiveContainer width="100%" height={400}>
            ...
            bottom: 0,
              ...
              <Area type="monotone" dataKey="pending" stackId="1" stroke={chartConfig.Pending.color} fill={chartConfig.Pending.color} fillOpacity={0.4}/>
              <Area type="monotone" dataKey="accepted" stackId="1" stroke={chartConfig.Accepted.color} fill={chartConfig.Accepted.color} fillOpacity={0.4}/>
              <Area type="monotone" dataKey="rejected" stackId="1" stroke={chartConfig.Rejected.color} fill={chartConfig.Rejected.color} fillOpacity={0.4}/>
            </AreaChart>
          </ResponsiveContainer>
        </ChartContainer>
      </CardContent>
        ...
        <div className="flex w-full items-start gap-2 text-sm">
          <div className="grid gap-2">
            ...
            <div className="flex items-center gap-2 leading-none text-muted-foreground">
              {((_a = transformedData[0]) === null || _a === void 0 ? void 0 : _a.date) && new Date(transformedData[0].date).toLocaleDateString()} - 
              {((_b = transformedData[transformedData.length - 1]) === null || _b === void 0 ? void 0 : _b.date) &&
