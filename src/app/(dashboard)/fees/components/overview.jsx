...
import { BarChart2, CreditCard, DollarSign, ArrowUp, ArrowDown, Calendar, Download, AlertCircle, RefreshCw } from 'lucide-react';
    ...
    return (<div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" onClick={() => exportReport('pdf')} disabled={loading || exporting}>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        Array(4).fill(0).map((_, index) => (<Card key={index}>
        ...
        // Actual stats cards
        getFormattedStats().map((stat, index) => (<Card key={index}>
              <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              <CardContent>
                ...
                <div className="flex items-center pt-1">
                  {stat.trend === 'up' ? (<ArrowUp className="h-4 w-4 text-green-500"/>) : (<ArrowDown className="h-4 w-4 text-red-500"/>)}
                  <span className={`text-xs ${stat.trend === 'up' ? 'text-green-500' : 'text-red-500'} ml-1`}>
                    {stat.change}
                  </span>
      ...
      <Card>
        ...
        collectionProgress && (<div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between">
      ...
      <Card>
        ...
        <div className="space-y-4">
              {Array(3).fill(0).map((_, index) => (<div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                  <div>
              ...
              {formattedTransactions.length > 0 ? (<div className="space-y-4">
                  {formattedTransactions.map((transaction) => (<div key={transaction.id} className="flex items-center justify-between p-4 border rounded-lg">
                      <div>
                      ...
                      <div className="text-right">
                        ...
                        <Badge variant={transaction.type === 'payment' ? 'default' :
