...
export default function SchoolManagement() {
    ...
    const handleClassSubmit = async (values) => {
        try {
            if (editingClass) {
                const updateData = Object.assign(Object.assign(Object.assign({}, editingClass), values), { slots: values.capacity || editingClass.slots, students_count: editingClass.students_count || 0 });
                ...
                const createData = Object.assign(Object.assign({}, values), { slots: values.capacity || 0, capacity: values.capacity || 0, students_count: 0 });
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex gap-2">
                  <Input placeholder="Search schools..." className="w-[300px]"/>
              ...
              <Table>
                ...
                <TableBody>
                  {isLoading ? (<TableRow>
                    ...
                    </TableRow>) : schools.length === 0 ? (<TableRow>
                      <TableCell colSpan={6} className="text-center">
                        No schools found
                      </TableCell>
                    </TableRow>) : (schools.map((school) => (<TableRow key={school.id}>
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                ...
                                <AlertDialogAction onClick={() => handleDelete(school.id)} className="bg-destructive text-destructive-foreground">
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
  ...
  <DialogContent className="sm:max-w-[525px]">
    <Form {...classForm}>
      <form onSubmit={classForm.handleSubmit(handleClassSubmit)}>
        ...
        <div className="grid gap-4 py-4">
          <FormField control={classForm.control} name="name" render={({ field }) => (<FormItem>
          ...
          <FormField control={classForm.control} name="level" render={({ field }) => (<FormItem>
          ...
          <FormField control={classForm.control} name="capacity" render={({ field }) => (<FormItem>
                <FormLabel>Capacity</FormLabel>
                <FormControl>
                  <Input type="number" {...field}/>
                </FormControl>
          ...
          <FormField control={classForm.control} name="school_id" render={({ field }) => (<FormItem>
                <FormLabel>School</FormLabel>
                <FormControl>
                  <select value={field.value} onChange={(e) => field.onChange(Number(e.target.value))} className="w-full rounded-md border p-2">
        ...
        <DialogFooter>
              ...
              <Table>
                ...
                <TableBody>
                  {isLoading ? (<TableRow>
                    ...
                    </TableRow>) : !(classes === null || classes === void 0 ? void 0 : classes.length) ? (<TableRow>
                      <TableCell colSpan={6} className="text-center">No classes found</TableCell>
                    </TableRow>) : (classes.map((cls) => {
            var _a;
            return (<TableRow key={cls.id}>
                        <TableCell className="font-medium">{cls.name}</TableCell>
                        <TableCell>Level {cls.level}</TableCell>
                        <TableCell>{(_a = schools.find(s => s.id === cls.school_id)) === null || _a === void 0 ? void 0 : _a.name}</TableCell>
                        <TableCell>{cls.capacity || 'N/A'}</TableCell>
                        <TableCell>{cls.students_count || 0} students</TableCell>
                        <TableCell className="text-right">
                          <Button variant="ghost" size="icon" onClick={() => handleClassEdit(cls)}>
                            <Edit className="h-4 w-4"/>
                          </Button>
                          <AlertDialog>
                            <AlertDialogTrigger asChild>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => handleClassDelete(cls.id)} className="bg-destructive text-destructive-foreground">
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
          ...
          <TabsContent value="categories">
            ...
            return (<TableRow key={category.id}>
                        ...
                        <TableCell>{(_a = schools.find(s => s.id === category.school_id)) === null || _a === void 0 ? void 0 : _a.name}</TableCell>
                        <TableCell>
                        ...
                        <TableCell className="text-right">
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent>
                              ...
                              <AlertDialogFooter>
                                <AlertDialogCancel>Cancel</AlertDialogCancel>
                                <AlertDialogAction onClick={() => handleCategoryDelete(category.id)} className="bg-destructive text-destructive-foreground">
                                  Delete
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
