...
export default function FeeManagement() {
    ...
    const filteredFees = fees.filter(fee => { var _a; return (_a = fee.category_name) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(searchTerm.toLowerCase()); });
    return (<Card>
    <CardHeader>
          ...
          <TabsContent value="categories">
            <div className="space-y-4">
              ...
              <Table>
                ...
                <TableBody>
                  {filteredFees.map(fee => (<TableRow key={fee.id}>
