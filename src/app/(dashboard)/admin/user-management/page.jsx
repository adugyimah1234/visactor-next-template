...
import { getAllUsers, updateUser, createUser, deleteUser } from '@/services/users';
...
export default function UserManagement() {
    ...
    const lastEditButtonRef = useRef(null);
    ...
    const onSubmit = async (values) => {
        ...
        try {
            ...
            toast({
                title: "Error",
                description: ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.error) || "Failed to create user",
                variant: "destructive",
                duration: 5000,
            });
        }
    ...
    return (<Card>
      <CardContent className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div className="flex gap-2">
            <div className="relative w-[300px]">
              ...
              <Input placeholder="Search users..." className="pl-10 w-full" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
            </div>
             <Select value={String(roleFilter)} onValueChange={(value) => {
          ...
          <Dialog open={isCreatingUser} onOpenChange={setIsCreatingUser}>
            ...
            return (<FormItem>
              ...
              <Select value={(_a = field.value) === null || _a === void 0 ? void 0 : _a.toString()} onValueChange={(value) => field.onChange(Number(value))}>
                <FormControl>
                  <SelectTrigger>
        ...
        <div className="relative">
          {isLoading && (<div className="absolute inset-0 bg-background/50 flex items-center justify-center">
            ...
            return (<TableRow key={user.id}>
                  ...
                  <TableCell>
                    <Badge variant="outline">
                      {((_a = roles.find(role => Number(role.id) === user.role_id)) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown'}
                    </Badge>
                  </TableCell>
                  <TableCell>
                    <Badge variant={user.status === 'active' ? 'default' : 'secondary'} className="cursor-pointer" onClick={() => handleStatusChange(user, user.status === 'active' ? 'inactive' : 'active')}>
                      {user.status}
                    </Badge>
                  </TableCell>
  ...
  <button onClick={(e) => handleEdit(user, e)}>
    Edit
            ...
            <DropdownMenuItem onClick={() => setConfirmDeleteUserId(user.id)} className="text-red-600">
  Delete
            </DropdownMenuItem>
            ...
            <Dialog open={!!editingUser} onOpenChange={(open) => {
                    ...
                    if (!open) {
                        setEditingUser(null);
                        (_a = lastEditButtonRef.current) === null || _a === void 0 ? void 0 : _a.focus();
                    }
                }}>
  <DialogContent>
    <DialogHeader>
