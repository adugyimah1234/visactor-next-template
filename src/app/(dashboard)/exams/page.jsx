'use client';
import { Clipboard, Users, Calendar, CheckCircle2, Clock, Filter, Download } from 'lucide-react';
        ...
        <TabsContent value="upcoming" className="space-y-4">
          <div className="flex justify-between items-center">
            <div className="flex gap-2">
              <Input placeholder="Search exams..." className="w-[300px]"/>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            {upcomingExams.map((exam) => (<Card key={exam.id}>
                <CardHeader>
