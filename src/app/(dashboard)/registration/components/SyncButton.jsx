...
import { markRegistrationSynced, removeOfflineRegistration, } from '@/lib/offlineRegistrations';
...
export default function SyncButton() {
    ...
    return (<Button onClick={syncOfflineData} disabled={!hasOfflineData || isSyncing} variant="outline">
