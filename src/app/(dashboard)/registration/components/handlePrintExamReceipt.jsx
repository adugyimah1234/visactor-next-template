...
const handlePrintExamReceipt = (registration) => {
...
// PDF Export Function
const handleExportExamReceiptPDF = (registration) => {
...
const handleExportExamReceiptExcel = (registration) => {
    const data = [
        ['3GS.E.C. EXAMINATION REGISTRATION RECEIPT'],
        [''],
        ['Receipt Information'],
...
export { handlePrintExamReceipt, handleExportExamReceiptPDF, handleExportExamReceiptExcel };
