...
export default function ChangePasswordPage() {
    ...
    async function onSubmit(data) {
        ...
        try {
            ...
            const errorMessage = ((_b = (_a = error.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || "Failed to change password";
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                <FormField control={form.control} name="username" render={({ field }) => (<FormItem>
                      ...
                      <FormControl>
                        <Input type="text" placeholder="Enter your username" {...field} disabled={!!(user === null || user === void 0 ? void 0 : user.username)} // Disable if user is authenticated
        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>)}/>
