...
export default function ProfessionalLogin() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setLocalError(((_b = (_a = err === null || err === void 0 ? void 0 : err.response) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.message) || (err === null || err === void 0 ? void 0 : err.message) || 'Login failed. Please check your credentials.');
        }
        finally {
            setSocialLoading(false);
        }
    };
    return (<div className="flex min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
      {/* Left panel */}
        ...
        <div className="max-w-md text-white">
          ...
          <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
            ...
            <ul className="space-y-3">
              {["Real-time analytics", "Secure cloud access", "24/7 technical support", "Mobile-friendly interface"].map((item, i) => (<li key={i} className="flex items-center">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          {(localError || authError) && (<div className="mb-6 p-4 rounded-lg bg-red-50 border border-red-200 text-red-700 dark:bg-red-900/30 dark:border-red-800 dark:text-red-400">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative rounded-lg shadow-sm">
                ...
                <input id="username" name="username" required value={username} onChange={(e) => setUsername(e.target.value)} className="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg bg-white dark:bg-gray-800 dark:border-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="Your username"/>
              </div>
            </div>
            ...
            <button type="submit" disabled={socialLoading} className="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200">
              {socialLoading ? (<Loader className="h-5 w-5"/>) : (<>
                  Sign in
